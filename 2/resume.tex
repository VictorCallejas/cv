...
\name{Victor}{Callejas Fuentes\vspace{.2cm}}
\position{\large Machine Learning Engineer{\enskip\cdotp\enskip}Software Engineer\vspace{.2cm}}
%\address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

\mobile{(+34) 645 56 64 61}
\email{vcallejasfuentes@gmail.com}
%\github{posquit0}
\linkedin{victor-callejas-fuentes}
% \gitlab{gitlab-id}
